...
public class Dijkstra {
	...
	public List<Vertice> encontrarMenorCaminhoDijkstra(Grafo grafo, Vertice v1,
		...
		// Colocando as distancias iniciais
				...
				if (!vizinho.verificarVisita()) {
					...
					if (vizinho.getDistancia() > (atual.getDistancia() + atual
						...
						if (vizinho == v2) {
							...
							valorMenorCaminho = valorMenorCaminho + vizinho.getDistancia();
		...
		System.out.println("Esse e o valor do menor caminho feito pelo algoritmo:"
				+ valorMenorCaminho);
