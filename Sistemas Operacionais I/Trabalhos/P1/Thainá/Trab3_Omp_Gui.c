...
*/
//gcc Trab3_Omp_Gui.c -o Trab3_Omp_Gui -lm -fopenmp  
...
int main(int argc,char* argv[]){
	...
	#pragma omp parallel for schedule(guided, 1000) reduction(+:contp) //cada thread vai ter uma cópia da variável contp, fará a soma local com sua cópia e, ao sair da execução paralela, as somas locais vão ser adicionadas na variável global.
