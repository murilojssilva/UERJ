...
public class Filme //
{
	...
	public void aluga() throws CopiaNaoDisponivelEx
	{
		...
		{
			throw new CopiaNaoDisponivelEx("Quantidade indisponível no estoque.");
		}
		else
		{
			this.alugados++;
	...
	public void devolve() throws NenhumaCopiaAlugadaEx//getFilme.put(novoCliente.getCodigo(),novoCliente);iaAlugadaEx
	{
		if (this.alugados == 0)
		{
			throw new NenhumaCopiaAlugadaEx("Todos os filmes estão no estoque estoque.");
		}
		else
		{
			this.alugados--;
